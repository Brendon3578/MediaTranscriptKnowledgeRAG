    ...
    public class WhisperNetTranscriptionFacade : ITranscriptionFacade
    {
        ...
        public async Task<TranscriptionResultDto> TranscribeAsync(string filePath, string contentType, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                return new TranscriptionResultDto(finalTranscription, optimizedSegments, language);
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Otimiza os segmentos de transcrição para RAG e Embeddings.
        /// Agrupa segmentos temporais curtos em blocos maiores (30-90s) respeitando pontuação.
        /// </summary>
